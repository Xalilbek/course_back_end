...
class CityController extends Controller
{
    ...
    /**
     * @api {get} /msk/city Request all cities
     * @apiGroup Msk City
     *  
     ...
     *      }
     *    ],
     *    "first_page_url": "api.egundelik.com/msk/city?page=1",
     *    "from": 1,
     *    "last_page": 1,
     *    "last_page_url": "api.egundelik.com/msk/city?page=1",
     *    "next_page_url": null,
     *    "path": "api.egundelik.com/msk/city",
     *    "per_page": 10,
     *    "prev_page_url": null,
     *    "to": 2,
     *    "total": 2
    ...
    public function index()
    {
        ...
        $cities = City::when(request('name'), function($q){
            $q->where('name','like','%'.request('name').'%');
        })->paginate(10);
        return $this->sendSuccess($cities);
    }
    /**
     * @api {post} /msk/city Create city
     * @apiGroup Msk City
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    public function store()
    {
        ...
        $city->save();
        $city->createLog();
        return $this->sendSuccess(['inserted_id' => $city->id]);
    }
    /**
     * @api {delete} /msk/city/:id Delete city
     * @apiGroup Msk City
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    public function destroy($id)
    {
        ...
        $city->createLog('deleted');
        $city->delete();
        return $this->sendSuccess();
    }
    /**
     * @api {put} /msk/city/:id Update city
     * @apiGroup Msk City
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
