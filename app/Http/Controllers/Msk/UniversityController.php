...
class UniversityController extends Controller
{
    ...
    /**
     * @api {get} /msk/university Request all universities
     * @apiGroup Msk University
     *  
     ...
     *      }
     *    ],
     *    "first_page_url": "api.egundelik.com/msk/university?page=1",
     *    "from": 1,
     *    "last_page": 1,
     *    "last_page_url": "api.egundelik.com/msk/university?page=1",
     *    "next_page_url": null,
     *    "path": "api.egundelik.com/msk/university",
     *    "per_page": 10,
     *    "prev_page_url": null,
     *    "to": 2,
     *    "total": 2
    ...
    public function index()
    {
        ...
        $universities = University::when(request('name'), function($q){
            $q->where('name','like','%'.request('name').'%');
        })->paginate(10,['id','name']);
        return $this->sendSuccess($universities);
    }
    /**
     * @api {post} /msk/university Create university
     * @apiGroup Msk University
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    public function store()
    {
        ...
        $university->save();
        $university->createLog();
        return $this->sendSuccess(['inserted_id' => $university->id]);
    }
    /**
     * @api {delete} /msk/university/:id Delete university
     * @apiGroup Msk University
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    public function destroy($id)
    {
        ...
        $university->createLog('deleted');
        $university->delete();
        return $this->sendSuccess();
    }
    /**
     * @api {put} /msk/university/:id Update university
     * @apiGroup Msk University
     *  
     * @apiHeaderExample {json} Header-Example:
     * {
