...
class RegionController extends Controller
{
    ...
    /**
     * @api {get} /msk/region Request all regions
     * @apiGroup Msk Region
     * 
     ...
     * @apiParam {Integer} [city_id] filter city
     *
     ...
     *      }
     *    ],
     *    "first_page_url": "api.egundelik.com/msk/region?page=1",
     *    "from": 1,
     *    "last_page": 1,
     *    "last_page_url": "api.egundelik.com/msk/region?page=1",
     *    "next_page_url": null,
     *    "path": "api.egundelik.com/msk/region",
     *    "per_page": 10,
     *    "prev_page_url": null,
     *    "to": 1,
     *    "total": 1
    ...
    public function index()
    {
        ...
        $regions = Region::when(request('name'), function($q){
    ...
    /**
     * @api {post} /msk/region Create region
     * @apiGroup Msk Region
     * 
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    /**
     * @api {delete} /msk/region/:id Delete region
     * @apiGroup Msk Region
     * 
     * @apiHeaderExample {json} Header-Example:
     * {
    ...
    /**
     * @api {put} /msk/region/:id Update region
     * @apiGroup Msk Region
     * 
     * @apiHeaderExample {json} Header-Example:
     * {
